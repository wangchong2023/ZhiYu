...
SKIP_FILES = {
    ...
    "project.yml",          # 由 scripts-run-dev-bootstrap.sh 从 Config/project.yml.template 生成的文件，包含展开后的路径
}
...
def main():
    ...
    print(
        ...
        "   • 无法修复的误报 → 在 check-code-absolute-paths.py 的 ALLOWED_PATTERNS 中添加白名单"
    )
    return 1
