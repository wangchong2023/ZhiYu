...
GATEKEEPER_AUDIT_STEPS = [
    ("SwiftLint 静态规范审计", ["bash", "Tools/Gatekeeper/Lint/check_swiftlint.sh"]),
    ("Domain Purity 领域层纯净化审计", ["python3", "Tools/Gatekeeper/Architecture/check_domain_purity.py"]),
    ("L10n 本地化合规审计", ["python3", "Tools/Gatekeeper/Compliance/check_localization.py"]),
    ("Prompt 治理与安全合规审计", ["python3", "Tools/Gatekeeper/Compliance/check_prompt_governance.py"]),
    ("存储层常量提取审计", ["python3", "Tools/Gatekeeper/Compliance/check_storage_constants.py"]),
    ("魔鬼数字提取审计", ["python3", "Tools/Gatekeeper/Compliance/check_magic_numbers.py"]),
    ("硬编码敏感信息扫描", ["python3", "Tools/Gatekeeper/Release/check_hardcoded_secrets.py"]),
    ("HIG 视觉规范度审计", ["python3", "Tools/Gatekeeper/Compliance/check_hig_compliance.py"]),
    ("App Store 上架就绪度审计", ["python3", "Tools/Gatekeeper/Release/check_appstore_readiness.py"]),
    ("L0-L3 单向依赖架构审计", ["python3", "Tools/Gatekeeper/Architecture/check_architecture_dependency.py"]),
    ...
    ("死代码与迁移残留审计 (Periphery)", ["python3", "Tools/Gatekeeper/Sanity/check_dead_code.py"]),
]
