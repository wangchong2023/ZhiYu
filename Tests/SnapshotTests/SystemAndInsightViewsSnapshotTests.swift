//
//  SystemAndInsightViewsSnapshotTests.swift
//  ZhiYu
//
...
@MainActor
final class SystemAndInsightViewsSnapshotTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        // 重置 GlobalModelManager 单例的响应式状态，避免前序测试注入的远程清单导致 ModelStoreView 快照漂移
        GlobalModelManager.shared.resetForTesting()
