...
final class CoreUtilitiesSupplementTests: XCTestCase {
    ...
    func testLocalizedTrRegisteredKeyReturnsNonEmpty() {
    ...
    func testLocalizedTrUnregisteredKeyReturnsMissingMarker() {
    ...
    func testLocalizedBestMatchExactMatch() {
    ...
    func testLocalizedBestMatchPrefixMatch() {
    ...
    func testLocalizedBestMatchNoMatchNonEmptyDictReturnsAnyValue() {
        Localized.languageMode = .english
    ...
    func testLocalizedBestMatchEmptyDictReturnsFallback() {
        Localized.languageMode = .english
    ...
    func testLocalizedBestMatchEnFallback() {
    ...
    func testLocalizedCurrentLanguageAutoModeNonEmpty() {
    ...
    func testLanguageModeAllCasesDisplayNameNonEmpty() {
    ...
    func testLanguageModeIdEqualsRawValue() {
        for mode in LanguageMode.allCases {
    ...
    func testSnapshotServiceSaveSnapshotCreatesFile() {
    ...
    func testSnapshotServiceGetHistoryNoSnapshotReturnsEmptyArray() {
        let service = SnapshotService()
    ...
    func testSnapshotServiceRollbackReturnsContent() {
        let service = SnapshotService()
        let pageID = UUID()
    ...
    func testSnapshotServiceRollbackInvalidURLReturnsNil() {
        let service = SnapshotService()
    ...
    func testSnapshotInfoIdEqualsUrlPath() {
    ...
    func testDependencyContainerMockReturnsEmptyContainer() {
    ...
    func testDependencyContainerPropertiesReadWrite() {
    ...
    func testDependencyContainerInitNoCrash() {
    ...
    func testAccessibilityServiceShouldAnimateInitialTrue() {
    ...
    func testAccessibilityServiceShouldAnimateReduceMotionFalse() {
        let service = AccessibilityService()
    ...
    func testAccessibilityServicePageAnnouncementNoTagsNoCrash() {
    ...
    func testAccessibilityServicePageAnnouncementWithTagsContainsTags() {
        let result = AccessibilityService.pageAnnouncement(
            title: "标题", pageTypeDisplay: "笔记",
    ...
    func testAccessibilityServiceGraphNodeAnnouncementContainsTitleAndLinkCount() {
    ...
    func testAccessibilityServicePublishedPropertiesReadWrite() {
        let service = AccessibilityService()
    ...
    func testTestModeDetectorIsMockDataModeNonMockEnvFalse() {
    ...
    func testTestModeDetectorShouldResetUserDefaultsNoArgFalse() {
