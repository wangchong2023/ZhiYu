//
//  CoreConstantsDeepTests.swift
//  ZhiYuTests
//
//  系统层级：[L0] 底层基座层测试
//  核心职责：验证 CoreConstants / AppConstants / APIPaths 常量集的完整性。
//           覆盖语言代码、安全、工作流、错误域、DeepLink、Markdown 语法、
//           PromptInjection 定界符、网络/存储/订阅/版本常量、API 路径与外部 URL。
//
