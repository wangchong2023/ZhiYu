//
//  ImportRecordDeepTests.swift
//  ZhiYuTests
//
//  合并自 2 个碎片化测试文件：ImportRecordAndComparisonDeepTests.swift, ImportRecordSectionAndTabsDeepTests.swift
//
...
@MainActor
final class ImportRecordDeepTests: XCTestCase {
    ...
    func testComparisonDetailBodyViewWithoutFrontmatter() {
        ...
        XCTAssertEqual(page.title, "架构模式对比")
    }
