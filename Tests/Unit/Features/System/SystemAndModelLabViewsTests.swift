//
//  SystemAndModelLabViewsTests.swift
//  ZhiYuTests
//
...
//
//  系统层级：[L3] 表现层测试
//  核心职责：验证 ModelLabView（参数Sheet/指标面板/多用例沙盒）、
//            SystemStatsView、DeveloperSettingsView、PluginCenterView 及 MarkdownRendererView 交互。
//
...
@MainActor
final class SystemAndModelLabViewsTests: XCTestCase {
