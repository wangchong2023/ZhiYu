...
final class ModelLabRunSimulationDeepTests: XCTestCase {
    ...
    func testRunSimulationIsGeneratingStateTogglesCorrectly() async {
    ...
    func testRunSimulationGeneratedTextNonEmpty() async {
        let manifest = makeManifest()
        await manager.runSimulation(for: .aiChat, model: manifest, prompt: "测试")
    ...
    func testRunSimulationCurrentStatsPrefillLatencyNonZero() async {
        let manifest = makeManifest()
        await manager.runSimulation(for: .aiChat, model: manifest, prompt: "测试")
    ...
    func testRunSimulationCurrentStatsFirstTokenLatencyNonZero() async {
        let manifest = makeManifest()
        await manager.runSimulation(for: .aiChat, model: manifest, prompt: "测试")
    ...
    func testRunSimulationCurrentStatsMemoryUsageNonZero() async {
        let manifest = makeManifest()
        await manager.runSimulation(for: .aiChat, model: manifest, prompt: "测试")
    ...
    func testRunSimulationAskImagePrefillLatencyBaseline450() async {
    ...
    func testRunSimulationAskImageFirstTokenLatencyBaseline520() async {
        let manifest = makeManifest(parameterCount: "2B")
        await manager.runSimulation(for: .askImage, model: manifest, prompt: "图片")
    ...
    func testRunSimulationNonAskImagePrefillLatencyBaseline180() async {
        let manifest = makeManifest(parameterCount: "2B")
    ...
    func testRunSimulationNonAskImageFirstTokenLatencyBaseline210() async {
        let manifest = makeManifest(parameterCount: "2B")
        await manager.runSimulation(for: .aiChat, model: manifest, prompt: "对话")
    ...
    func testRunSimulation4BModelAskImagePrefillLatencyIs530() async {
    ...
    func testRunSimulation4BModelAskImageFirstTokenLatencyIs615() async {
        let manifest = makeManifest(parameterCount: "4B")
        await manager.runSimulation(for: .askImage, model: manifest, prompt: "图片")
    ...
    func testRunSimulation4BModelNonAskImagePrefillLatencyIs260() async {
        let manifest = makeManifest(parameterCount: "4B")
        await manager.runSimulation(for: .aiChat, model: manifest, prompt: "对话")
    ...
    func testRunSimulation4BModelNonAskImageFirstTokenLatencyIs305() async {
        let manifest = makeManifest(parameterCount: "4B")
        await manager.runSimulation(for: .aiChat, model: manifest, prompt: "对话")
    ...
    func testRunSimulation4BModelMemoryUsageAround1240() async {
        let manifest = makeManifest(parameterCount: "4B")
        await manager.runSimulation(for: .aiChat, model: manifest, prompt: "对话")
    ...
    func testRunSimulationNon4BModelMemoryUsageAround850() async {
        let manifest = makeManifest(parameterCount: "2B")
        await manager.runSimulation(for: .aiChat, model: manifest, prompt: "对话")
    ...
    func testRunSimulationIsGeneratingNoReentry() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationEmptyPromptStillGeneratesOfflineSimulation() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationAskImageResponseContainsMultimodalMarker() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationAudioScribeResponseContainsVoiceMarker() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationAiChatResponseContainsModelName() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationAgentSkillsResponseContainsAgentMarker() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationPromptLabResponseContainsTemperature() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationPromptLabResponseContainsTopP() async {
        let manifest = makeManifest()
        await manager.runSimulation(for: .promptLab, model: manifest, prompt: "")
    ...
    func testRunSimulationTinyGardenResponseContainsPlantingMarker() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationMobileActionsResponseContainsShortcutsMarker() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationLongPromptTruncatedToFirst15Chars() async {
        let manifest = makeManifest()
    ...
    func testRunSimulationShortPromptNotTruncated() async {
        let manifest = makeManifest()
        let shortPrompt = "短提示"
    ...
    func testStopSimulationSetsIsGeneratingToFalse() {
        manager.isGenerating = true
    ...
    func testStopSimulationAlreadyFalseNoCrash() {
